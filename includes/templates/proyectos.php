...
if ($_SERVER['REQUEST_URI'] === '/proyectos.php') {
    $proyectos = Proyecto::all();
} else {
...
<div class="row justify-content-between mt-3">
    <?php foreach ($proyectos as $proyecto): ?>
        <div class="proyecto col-md-6 mb-4">
            <a href="proyecto.php?id=<?php echo s($proyecto->id); ?>">
                <img src="/uploads/images/<?php echo s($proyecto->imagen); ?>" alt="Portada del Proyecto " class="img-fluid">
